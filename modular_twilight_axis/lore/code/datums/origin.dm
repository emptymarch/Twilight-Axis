...
/datum/virtue/origin/heimland
	...
	map_x = 11.3
	map_y = 31.6
	map_state_id = "heimland"
	map_state_name = "Гронн"
	map_origin_name = "Северные острова"
	list_group_id = "gronn"
	list_group_name = "Гронн"
	list_group_order = 5
	list_item_order = 1
	name = "Gronnic - Heimlander"
	origin_name = "Heimland"
	added_languages = list(/datum/language/gronnic)
	desc = "Я происхожу с Северных островов Хеймланда — сурового архипелага, где море кормит сильных. Здесь ценят честное слово, искусство мореплавания и богатство, добытое торговлей, китобойным промыслом или дальними походами.<br>"
	origin_desc = "<br><br><b><a href='https://wiki.twilight-fortress-axis.ru/index.php?title=%D0%93%D1%80%D0%BE%D0%BD%D0%BD'>Хеймланд</a></b> — архипелаг Северных островов. Изрезанные фьордами берега, удобные естественные гавани и богатые рыбой воды сделали море неотъемлемой частью жизни местных жителей. Несмотря на суровый климат и опасные штормы, условия здесь значительно мягче, чем в глубине Северных Пустошей, благодаря чему островитяне издавна развивали судостроение, китобойный промысел, торговлю и дальнее мореплавание.<br><br>Общество Хеймланда построено вокруг независимых кланов, возглавляемых ярлами. На ежегодных тингах представители сильнейших родов обсуждают вопросы торговли, совместных походов и заключения союзов. Репутация и соблюдение клятв имеют для островитян огромное значение: клан, прославившийся нарушением договоров, быстро лишается союзников и доступа к чужим гаваням.<br><br>Как и все гроннцы, жители Хеймланда поклоняются Шести Зверям, духам природы, отвергая религии юга. Их корабли можно встретить практически по всей Гримории — от Валории до Зибантии и далёкого Казенгуна. Для одних они известны как торговцы и опытные мореходы, для других — как беспощадные рейдеры, ведь сами северяне редко проводят чёткую грань между этими ремёслами.<br><br>"

/datum/virtue/origin/fjall
	map_group_order = 3
	map_state_order = 9
	map_origin_order = 2
	map_visible = TRUE
	...
	origin_name = "Fjall"
	added_languages = list(/datum/language/gronnic)
	desc = "Я происхожу из Фьялла — суровых Северных Пустошей, где лишь сильнейшие переживают долгую зиму. Здесь жизнь зависит не от урожая, а от удачной охоты, богатых рудников и силы клана, способного отстоять своё право на существование.<br>"
	origin_desc = "<br><br><b><a href='https://wiki.twilight-fortress-axis.ru/index.php?title=%D0%93%D1%80%D0%BE%D0%BD%D0%BD'>Фьялл</a></b>, известный также как Северные Пустоши или Сестринские земли, занимает материковую часть Гронна. Это холодная каменистая равнина с коротким летом, свирепыми буранами и крайне скудными природными ресурсами. Земледелие здесь почти невозможно, поэтому основу жизни составляют охота, добыча руды, ограниченное скотоводство и военные набеги на южные земли Хаммерхолда и других соседей.<br><br>Власть во Фьялле принадлежит сильнейшим вождям и их дружинам. В отличие от островитян, привыкших полагаться на торговлю и договоры, кланы Пустошей считают главной гарантией будущего военную силу и способность взять необходимое собственными руками. Междоусобные конфликты здесь обычны, однако перед лицом общего врага кланы способны объединиться под знаменем признанного полководца, пусть подобные союзы редко переживают окончание войны.<br><br>Подобно остальным гроннцам, жители Фьялла чтят Шесть Зверей, полагаясь на советы шаманов и древние традиции предков, ведь в землях, где каждая зима может стать последней, вера и сила клана остаются единственной надёжной опорой.<br><br>"
